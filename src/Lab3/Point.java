...
public class Point extends JComponent {
    ...
    /**
     * Draws a line from this Lab3.Point to Lab3.Point p.
     *
     * @param p - The Lab3.Point to connect to this one with a line.
     * @param g - Graphics object.
     */
    ...
    /**
     * Comparison - Is this Lab3.Point lexicographically lesser than p?
     *
     * @param p - The other Lab3.Point to compare with.
     * @return - boolean, true if this Lab3.Point is the smaller of the two. False otherwise.
     */
    ...
    /**
     * Comparison - Is this Lab3.Point lexicographically greater than p?
     *
     * @param p - The other Lab3.Point to compare with.
     * @return - boolean, true if this Lab3.Point is the greater of the two. False otherwise.
     */
